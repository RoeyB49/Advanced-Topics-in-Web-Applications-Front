...
const CreatePost: React.FC<CreatePostProps> = ({
  ...
  return (
    ...
    >
      <DialogTitle>Create Lost or Found Post</DialogTitle>

      <DialogContent sx={{ pt: 2 }}>
        <Box sx={{ mb: 3 }}>
          <Typography variant="body1" color="text.secondary" gutterBottom>
            Describe the item and provide any relevant details to help recognize
            and recover it.
          </Typography>
        </Box>
        <TextField
        ...
        >
          ...
          <Typography variant="body1" gutterBottom>
            {dragActive ? "Drop the image here" : "Upload an image of the item"}
          </Typography>
      ...
      <DialogActions sx={{ px: 3, pb: 3 }}>
        ...
        >
          {creatingPost ? "Posting..." : "Post Item"}
        </Button>
      </DialogActions>
